        ...
        <div class="container">
            ...
            <div class="sc-fsfFfa">
                            ...
                            <div class="group-detaile">
                                <div>
                                    <div class="detaile-item">
                                        ...
                                        <p class="detaile-value">{{ $games->created_at }}</p>
                                    </div>
                                    <div class="detaile-item">
                                        <p class="detaile-name">Updated:</p>
                                        <p class="detaile-value">{{ $games->updated_at }}</p>
                                    </div>
                                </div>
                                    <a href="{{route('games.show.page', $games->id)}}" class="detaile-btn-custom">See More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div style="display: flex; align-items: center; margin-top: 50px;">
                    <div class="container">
                        <a class="card-button btn-card" href="{{route('games.page')}}"><span>See More Games</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="sc-FgFhjg">
                @foreach ($storeGame as $storeGames)
                    ...
                    <div class="card-img">
                    <img src="{{ $storeGames->cover_image }}" alt="{{ $storeGames->name }}" loading="lazy">
                    </div>
                    <div class="card-container">
                    <ul class="card-store-info">
                        <li>
                            <span class="text-white">Platforms:</span>
                            <a>{{ $storeGames->platforms }}</a>
                        </li>
                        <li>
                            <span class="text-white">Games rating:</span>
